...
each with a variety of opportunities for regulation. 
At the outset, DNA sequences
...
including a changed rate of proliferation \parencite{slator1918some}, 
...
regulates its most essential project of growth 
in the face of diverse limitations.

Nutrient availability is described in terms of the 
...
nutrient availability and growth rates is similar but of opposite
...
classical NCR-regulated gene is the general amino-acid permease
\textit{GAP1}.
Gap1p transport activity is repressed much faster than the 
re-localization and
...
is mediated by a ubiquitinyation mark that inactivates the permease
...
Given the assumption that adaptation implies function
\parencite{gould1979spandrels}, what purpose
might this rapid repression of mRNA fulfill?
...
would be to re-invest gene expression machinery activity in the
task of expressing more gene 
...
\cite{shachrai2010cost} induced the expression of a fluorescent 
protein at
...
recognizes \textit{cis}-element binding motifs in the RNA to direct 
cleavage and polyadenylation to specific sites in the mRNA. 
\afig{
...
rates. These measurements were made using
...
known to change growth rates, and thus is not known to be selected.
