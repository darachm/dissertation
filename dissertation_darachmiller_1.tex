...
%    \node[textz] at (-.5,-1.5) (acetyl CoA){};
    ...
    \node[textz,right=1cm of glu,fill=green] (gln) {glutamine};
    ...
    \node[textz,above=2cm of glu,fill=red] (pro) {proline};
...
%
    \draw[very thick] (-3,2) -- node[textz,above,pos=0.9] (dna) {genome} (3,2);
...
% First translating one
    ...
    \draw[fill=blue,color=blue] (-1.4,-2.050) ellipse (0.16cm and 0.08cm);
    \draw[fill=blue,color=blue] (-1.4,-1.900) ellipse (0.16cm and 0.16cm);
...
%    \draw[fill=blue,color=blue] (-0.4,-4.050) ellipse (0.16cm and 0.08cm);
%    \draw[fill=blue,color=blue] (-0.4,-3.900) ellipse (0.16cm and 0.16cm);
% NMD
...
%
    ...
    \draw[fill=blue,color=blue] (5.8,-3.050) ellipse (0.16cm and 0.08cm);
    \draw[fill=blue,color=blue] (5.8,-2.900) ellipse (0.16cm and 0.16cm);
...
% Final mRNA for deg
    ...
    \draw[fill=blue,color=blue] (-0.4,-6.050) ellipse (0.16cm and 0.08cm);
    \draw[fill=blue,color=blue] (-0.4,-5.900) ellipse (0.16cm and 0.16cm);
%
...
%
    ...
    \node[textz,rotate=40,anchor=east] at 
      ($(decap)+(-30:1.5)$) {AAAAA};
    \node[circle,fill=green!80!black,textz] at 
