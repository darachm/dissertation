...
\section{What is the function of rapid transcriptome reprogramming
...
\parencite{griffioen1996}. 
These are responsible for the protein subunits and biogenesis factors
responsible for ribosome biogenesis, and are well-correlated with 
growth rate in both dynamic and steady-state conditions 
\textbf{(does brauer or airoldi show this?)}. 
While some of the more numerous macro-molecules in the cell, ribosomes
are not infinite and are likely to be largely engaged in gene
expression \parencite{shah2013,recent?}.
During restrictions in growth conditions, 
ribosomes are less abundant in slow growing conditions. 
\textbf{(von der Haar estimates, Tu, Hwa) (Estimated this is probably
from 50k to about 200k.) }
...
A phenomenon that would be adaptive in this model has been seen in 
yeast before \parencite{griffioen1996} and recently by our lab
\parencite{arioldi2016steady}, wherein a transient 
relative-overproduction of ribosomal machinery is evident upon an
upshift in growth.

A prediction of this model is that mis-expression of an un-adaptive 
mRNA should have a larger cost during increases in growth rate than
during steady-state growth.  
There is evidence for this in \textit{E. coli}, where
\cite{shachari2010} induced the expression of a fluorphore at
...
% inhibition?
Thus, we might expect that a rapid repression of unnecessary mRNA may
have a functional role by virtue of freeing up gene expression
machinery for the expression of gene expression machinery.
Some support for this occurring in native gene regulation comes from
an integrative study of proteome and transcriptome dynamics from
the Gasch laboratory 
\parencite{lee2011dynamic}, wherein the authors found that the 
repression of mRNA did not correlate with a downregulation of 
protein products on the timescales measured.
This asymmetry makes sense, as with protein approximately 20 times
more stable than the mRNA they derive from 
\textbf{(one of those reviews)}, and might suggests that rapid
mRNA repression may serve a role to reallocate the 
extant translational
...
However, others have suggested other theories that might explain some
adaptive benefit for rapid repression, particularly through
accelerated mRNA degradation. One thought is that degradation can 
help to recycle nucleotides 
\parencite{kresnowati2006transcriptome}.
Identifying
the genetic factors responsible for the degradation would allow us to
test if one particular destabilization event is indeed adaptive.
...
\parencite{nissan2010decapping}, and thus may
...
\parencite{parker2012,coller2004?}.
While the GAL1 system is a convenient system for studying 
...
(Genomic Run On)
\parencite{garcia2004genomic}. This method uses a sarkosyl treatment 
\textbf{(and salt?)} to fix RNA PolII complexes onto genomic DNA by 
freezing their elongation. Extraction and a defined in-vitro polymerase
...
the mRNA. At low concentrations (< 50$\mu$M), the label does not
perturb growth \parencite{?}, and supports normal growth.
Fundamentally, these assays work by changing the
labelling frequency of mRNA at a time and tracking the dynamics as 
the labeled
...
%Previous work to do genetics of transcript dynamics neklesa 
%- sortseq,
%tavazoie's stuff
%Fluorescent readout of mRNA degradation mechanisms at the protein
%level. 
%18 bin experiment, van something boer or whatever
